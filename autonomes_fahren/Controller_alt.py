...
class MyController(Controller):
    ...
    def on_R3_down(self, value):
        ...
        global throttle
        throttle = self.Our_car_throttle
    ...
    def on_L3_right(self, value):
        ...
        global steering
        steering = self.Our_car_steering
...
#____________________
    ...
    def output(self):
        return self.Our_car_brake,  self.Our_car_throttle , self.Our_car_steering
